...
namespace TeachingCenter.Controllers
{
    public class AttendancesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Course,StudentId,Date,IsPresent,Notes")] Attendance attendance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Course,Date,IsPresent,Notes, StudentId")] Attendance attendance)
        {
            if (id != attendance.Id)
            {
